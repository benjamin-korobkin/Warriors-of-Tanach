...
const STANDARD_FONT_SIZE = 18  # Increased from 12 for better mobile readability
...
var _card_text := ""  ## TODO: This is bad practice. private vars should be kept private.
...
#	print_debug(scaled_fonts.get(node.name, 1))
	...
	if cached_font_size:
		...
		#yield(get_tree(), "idle_frame")  ## TODO: Testing removing this
